...
CROSS JOIN (VALUES
    ...
    ('URINE_PROTEIN', 'ANY', 'NORMAL_A', NULL, TRUE, NULL, TRUE, 'NEGATIVE', 10, '1쪽 요단백', '원문 음성(-)'),
    ('URINE_PROTEIN', 'ANY', 'NORMAL_B', NULL, TRUE, NULL, TRUE, 'TRACE', 20, '1쪽 요단백', '원문 약양성(±)'),
    ('URINE_PROTEIN', 'ANY', 'DISEASE_SUSPECTED', NULL, TRUE, NULL, TRUE, 'POSITIVE_1', 30, '1쪽 요단백', '원문 양성 1+'),
    ('URINE_PROTEIN', 'ANY', 'DISEASE_SUSPECTED', NULL, TRUE, NULL, TRUE, 'POSITIVE_2', 30, '1쪽 요단백', '원문 양성 2+'),
    ('URINE_PROTEIN', 'ANY', 'DISEASE_SUSPECTED', NULL, TRUE, NULL, TRUE, 'POSITIVE_3', 30, '1쪽 요단백', '원문 양성 3+'),
    ('URINE_PROTEIN', 'ANY', 'DISEASE_SUSPECTED', NULL, TRUE, NULL, TRUE, 'POSITIVE_4', 30, '1쪽 요단백', '원문 양성 4+'),
